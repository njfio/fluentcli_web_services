<template>
    <div
        class="flex items-center justify-between px-4 py-2 text-xs text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div class="flex items-center space-x-2">
            ...
            <span class="font-medium text-blue-500 dark:text-blue-400">{{ providerModel }}</span>
        </div>
        <div class="flex items-center space-x-2">
            <button
                class="hover:text-gray-700 dark:hover:text-gray-300 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 rounded p-1"
                :title="copyButtonTitle" @click="copyMessageContent" :class="{ 'text-green-500': copied }">
